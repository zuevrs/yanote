...
| `yanote-recorder-spring-activemq` | ActiveMQ Artemis-backed Spring JMS recorder path for the first queue-only `jms` proof boundary | Public release module with narrow explicit support boundary |
