    ...
    public enum Action {
        ...
        public static Action fromJson(String value) {
            ...
            return switch (normalized) {
                ...
                default -> throw new IllegalArgumentException("Unsupported jms action: " + value);
            };
        }
    }
    ...
    public enum HeaderCaptureState {
        ...
        public static HeaderCaptureState fromJson(String value) {
            ...
            return switch (normalized) {
                ...
                default -> throw new IllegalArgumentException("Unsupported jms header capture state: " + value);
            };
        }
    }
    ...
    public enum HeaderCaptureReason {
        ...
        public static HeaderCaptureReason fromJson(String value) {
            ...
            return switch (normalized) {
                ...
                default -> throw new IllegalArgumentException("Unsupported jms header capture reason: " + value);
            };
        }
    }
