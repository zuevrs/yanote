    ...
    public enum HeaderCaptureState {
        ...
        public static HeaderCaptureState fromJson(String value) {
            ...
            return switch (normalized) {
                ...
                default -> throw new IllegalArgumentException("Unsupported kafka header capture state: " + value);
            };
        }
    }
    ...
    public enum HeaderCaptureReason {
        ...
        public static HeaderCaptureReason fromJson(String value) {
            ...
            return switch (normalized) {
                ...
                default -> throw new IllegalArgumentException("Unsupported kafka header capture reason: " + value);
            };
        }
    }
