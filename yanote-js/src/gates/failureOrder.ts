...
const SEMANTIC_CODE_RANK: Record<string, number> = {
  ...
  ASYNC_SEMANTIC_MISSING_HEADER: 5,
  ASYNC_SEMANTIC_UNAVAILABLE_HEADER: 6,
  ASYNC_SEMANTIC_INVALID_HEADER: 7,
  ASYNC_SEMANTIC_UNVERIFIABLE_HEADERS: 8,
  ASYNC_SEMANTIC_AMBIGUOUS_MESSAGE: 9,
  ASYNC_SEMANTIC_MESSAGE_MISMATCH: 10,
  ASYNC_SEMANTIC_UNMATCHED_EVIDENCE: 11,
  SEMANTIC_HTTP_MISSING_SECURITY: 12,
  SEMANTIC_HTTP_UNAVAILABLE_SECURITY: 13,
  SEMANTIC_HTTP_UNSUPPORTED_SECURITY: 14,
  SEMANTIC_HTTP_INVALID_REQUEST_PARAMETER: 20,
  SEMANTIC_HTTP_UNAVAILABLE_REQUEST_PARAMETER: 21,
  SEMANTIC_HTTP_UNSUPPORTED_REQUEST_PARAMETER: 22,
  SEMANTIC_HTTP_INVALID_BODY: 30,
  SEMANTIC_HTTP_MISSING_BODY: 31,
  SEMANTIC_HTTP_MISSING_CONTENT_TYPE: 32,
  SEMANTIC_HTTP_MEDIA_TYPE_MISMATCH: 33,
  SEMANTIC_HTTP_UNSUPPORTED_MEDIA_TYPE: 34,
  SEMANTIC_HTTP_UNSUPPORTED_SCHEMA_FORMAT: 35,
  SEMANTIC_HTTP_UNSUPPORTED_SCHEMA: 36,
  SEMANTIC_SPEC_INVALID: 40,
