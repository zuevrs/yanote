...
const SEMANTIC_CODE_RANK: Record<string, number> = {
  ...
  SEMANTIC_HTTP_INVALID_BODY: 20,
  SEMANTIC_HTTP_MISSING_BODY: 21,
  SEMANTIC_HTTP_MISSING_CONTENT_TYPE: 22,
  SEMANTIC_HTTP_MEDIA_TYPE_MISMATCH: 23,
  SEMANTIC_HTTP_UNSUPPORTED_MEDIA_TYPE: 24,
  SEMANTIC_HTTP_UNSUPPORTED_SCHEMA: 25,
