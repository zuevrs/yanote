...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "yanote-recorder-spring-activemq"
            pom {
                name.set("Yanote Recorder Spring ActiveMQ")
                description.set("ActiveMQ Artemis-backed Spring JMS recorder integration for Yanote event capture.")
