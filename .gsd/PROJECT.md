...
- [ ] M009: HTTP And Kafka Evidence Truth Hardening — Make recorder, JSONL, analyzer, report, and gate surfaces distinguish omitted evidence from true semantic drift across the existing HTTP/OpenAPI and Kafka/AsyncAPI product boundary.
