...
- [x] **T01: Policy and exclusion foundation** `est:31min`
...
- [x] **T02: Evaluator and fail-closed enforcement** `est:46min`
...
- [x] **T03: Integrated governance output contract** `est:39min`
