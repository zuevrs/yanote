...
- [x] **T01: 04-java-build-and-ci-delivery-surfaces 01** `est:19 min`
...
- [x] **T02: 04-java-build-and-ci-delivery-surfaces 02** `est:9 min`
...
- [x] **T03: 04-java-build-and-ci-delivery-surfaces 03** `est:30 min`
...
- [x] **T04: 04-java-build-and-ci-delivery-surfaces 04** `est:3 min`
