...
- [x] **T01: Status and parameter coverage primitives** `est:8min`
...
- [x] **T02: Deterministic report contract boundary** `est:5min`
...
- [x] **T03: Layered coverage CLI integration** `est:24min`
