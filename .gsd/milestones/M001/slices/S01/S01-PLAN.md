...
- [x] **T01: TypeScript semantic extraction and diagnostics** `est:2min`
...
- [x] **T02: Java semantic extraction and diagnostics** `est:4min`
...
- [x] **T03: Node matcher and CLI fail-closed semantics** `est:4min`
...
- [x] **T04: Java matcher and coverage integration** `est:2min`
...
- [x] **T05: Cross-runtime parity fixture contract** `est:6min`
