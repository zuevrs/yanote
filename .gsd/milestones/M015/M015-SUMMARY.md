...
key_decisions:
  ...
  - D065 — Keep the combined HTTP plus async surface as attributed aggregation of canonical child reports rather than a blended denominator.
...
**M015 closed Yanote’s first non-Kafka async path and child-attributed combined reporting by proving protocol-aware AMQP/RabbitMQ analysis, live RabbitMQ recorder evidence, combined HTTP plus async artifacts, and aligned CI/docs/support surfaces on current HEAD.**
