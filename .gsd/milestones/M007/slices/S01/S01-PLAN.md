...
- [x] **T01: Lock the payload-bearing JSONL contract across Java and Node** `est:1h15m`
...
- [x] **T03: Retain AsyncAPI payload schema metadata beside canonical Kafka keys** `est:1h15m`
