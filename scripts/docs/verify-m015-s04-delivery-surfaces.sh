...
require_contains "$README_DOC" 'live-rabbitmq-proof/' 'RabbitMQ bundle path'
require_contains "$README_DOC" 'combined-proof/' 'combined bundle path'
...
require_contains "$DOCS_README" 'live-rabbitmq-proof/' 'docs landing RabbitMQ bundle path'
require_contains "$DOCS_README" 'combined-proof/' 'docs landing combined bundle path'
...
require_contains "$RELEASE_DOC" 'live-rabbitmq-proof/' 'release/support RabbitMQ bundle path'
require_contains "$RELEASE_DOC" 'combined-proof/' 'release/support combined bundle path'
...
require_contains "$SUPPORT_DOC" '.yanote-ci/live-kafka-proof/' 'support Kafka retained bundle path'
require_contains "$SUPPORT_DOC" 'build-and-test-artifacts/live-kafka-proof/' 'support Kafka collected bundle path'
require_contains "$SUPPORT_DOC" '.yanote-ci/live-rabbitmq-proof/' 'support RabbitMQ retained bundle path'
require_contains "$SUPPORT_DOC" 'build-and-test-artifacts/live-rabbitmq-proof/' 'support RabbitMQ collected bundle path'
require_contains "$SUPPORT_DOC" '.tmp/m015-s03-combined-proof/' 'support combined retained bundle path'
require_contains "$SUPPORT_DOC" 'build-and-test-artifacts/combined-proof/' 'support combined collected bundle path'
...
require_contains "$SUPPORT_DOC" 'combined-report/out/yanote-combined-report.json' 'support combined JSON request'
