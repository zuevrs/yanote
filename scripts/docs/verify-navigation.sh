...
require_contains "$PUBLIC_SURFACE_PROOF_DOC" "bash scripts/docs/verify-public-surface.sh" "canonical rerun command"
require_contains "$PUBLIC_SURFACE_PROOF_DOC" "PUBLIC-01" "stage label"
require_contains "$PUBLIC_SURFACE_PROOF_DOC" "PUBLIC-12" "stage label"
...
require_contains "$RELEASE_SIGNING_DOC" "bash scripts/docs/verify-public-surface.sh" "final public-surface proof command"
...
require_before "$RELEASE_SIGNING_DOC" "bash scripts/ci/verify-release-pipeline.sh" "bash scripts/docs/verify-public-surface.sh" "release proof ordering"
...
require_not_contains "$ROOT_README" "verify-public-surface.sh" "maintainer-only proof command"
...
require_not_contains "$DOCS_README" "verify-public-surface.sh" "maintainer-only proof command"
require_not_contains "$QUICKSTART_DOC" "public-surface-proof.md" "maintainer-only proof leaf"
require_not_contains "$QUICKSTART_DOC" "verify-public-surface.sh" "maintainer-only proof command"
...
require_not_contains "$EXAMPLES_README" "verify-public-surface.sh" "maintainer-only proof command"
require_not_contains "$RELEASE_SUPPORT_DOC" "public-surface-proof.md" "maintainer-only proof leaf"
require_not_contains "$RELEASE_SUPPORT_DOC" "verify-public-surface.sh" "maintainer-only proof command"
